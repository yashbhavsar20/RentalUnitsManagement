...
class HouseTest {
    ...
    int streetNumber;
    int unitNumber;
    //Address address, String streetName, int streetNumber, PropertyDetails propertyDetails
    ...
    House house=new House(address,streetName,streetNumber,propertyDetails);
    ...
    void getPropertyType() {
        assertEquals("HOUSE",house.getPropertyType());
    }
    ...
    @Test
    void getStreetName() {
        assertEquals(streetName,house.getStreetName());
    }

    @Test
    void getStreetNumber() {
        assertEquals(streetNumber,house.getStreetNumber());
    }

    @Test
    void getPropertyDetails() {
        assertEquals(propertyDetails,house.getPropertyDetails());
    }

    @Test
    void displayProperty() {
        assertEquals(false,house.displayProperty());
    }
}